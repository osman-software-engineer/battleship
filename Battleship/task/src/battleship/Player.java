...
public class Player {
    ...
    public Player() {
        gameBoard = new Board(BOARD_SIZE, BOARD_SIZE);
        fogBoard = new Board(BOARD_SIZE, BOARD_SIZE);
    ...
    public void gameStarts(Player player, Scanner scanner, Ship[] ships) throws Exception {
        try {
            String userInput;
            Coordinates shipCoordinates;
            Coordinates shotCoordinates = null;
                userInput = scanner.nextLine();
                while (!player.getGameBoard().isShotLocationCorrect(userInput)) {
                ...
                shotCoordinates = getShotCoordinates(userInput);
                if (player.getGameBoard().getCoordinatesStatus(shotCoordinates).equalsIgnoreCase("occupied")) {
                    player.getGameBoard().takeShot(shotCoordinates);
                    player.getFogBoard().takeShot(shotCoordinates);
                    ...
                    for (Ship ship : ships) {
                        ...
                        int shotRow, shotCol;
                        Coordinates shipAddress = player.getGameBoard().getShipAddress(shipCoordinates, ship);
                    ...
                    player.getGameBoard().missedShot(shotCoordinates);
                    player.getFogBoard().missedShot(shotCoordinates);
                    System.out.println();
    ...
    public void setFogBoard(Board fogBoard) {
